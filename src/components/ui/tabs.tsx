...
export function Tabs<T extends string>({
  ...
  return (
    <div
      className={cn(
        fullWidth
          ? "border border-b-0 border-slate-200 bg-white shadow-[0_8px_30px_rgba(15,23,42,0.04)]"
    ...
    >
      <div
        ...
        className={cn(fullWidth ? "grid" : "inline-flex max-w-full overflow-x-auto")}
        style={
              ...
              className={cn(
                ...
                value === tab.id
                  ? fullWidth
                    ...
                    : "border-emerald-500 bg-emerald-500 text-white shadow-[0_-4px_16px_rgba(16,185,129,0.16)]"
                  : fullWidth
