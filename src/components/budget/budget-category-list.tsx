  ...
  return (
    <Card title="Budget Categories" eyebrow="Budget">
      <div className="space-y-4">
        {usage.map((category) => (
          <div className="space-y-2 border-b border-zinc-100 pb-4 last:border-0 last:pb-0" key={category.id}>
            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-3">
              ...
              <p className={category.isOverBudget ? "text-sm font-semibold text-rose-600" : "text-sm font-semibold text-teal-700"}>
