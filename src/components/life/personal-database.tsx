    ...
    <Card title="Personal Life Database" eyebrow="Notes" id="notes">
      <div className="grid min-w-0 gap-3 sm:grid-cols-2">
        {sections.map((section) => (
          <div className="rounded-md border border-zinc-100 bg-zinc-50 p-4" key={section.id}>
            <div className="flex items-start justify-between gap-3">
              <h3 className="min-w-0 break-words text-sm font-semibold text-zinc-950">{section.title}</h3>
